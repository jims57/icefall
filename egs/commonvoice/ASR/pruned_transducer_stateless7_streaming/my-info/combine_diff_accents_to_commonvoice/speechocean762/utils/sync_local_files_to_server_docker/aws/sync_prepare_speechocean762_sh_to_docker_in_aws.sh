...
#
# This script syncs the prepare_speechocean762.sh file from local machine to AWS server and then to Docker container

# Step 1: Run on local machine to copy the file to AWS server
echo "Creating directory on AWS server and copying prepare_speechocean762.sh..."
...
scp -i /Users/mac/.ssh/aws/aws-icefall.pem /Users/mac/Documents/GitHub/icefall/egs/commonvoice/ASR/pruned_transducer_stateless7_streaming/my-info/combine_diff_accents_to_commonvoice/speechocean762/prepare_speechocean762.sh ubuntu@3.22.99.8:~/icefall/egs/commonvoice/ASR/download/speechocean762-1.2.0/
...
ssh -i /Users/mac/.ssh/aws/aws-icefall.pem ubuntu@3.22.99.8 "docker cp ~/icefall/egs/commonvoice/ASR/download/speechocean762-1.2.0/prepare_speechocean762.sh 432a764e93ea:/root/icefall/egs/commonvoice/ASR/download/speechocean762-1.2.0/"
...
echo "4. Run the script: bash prepare_speechocean762.sh"