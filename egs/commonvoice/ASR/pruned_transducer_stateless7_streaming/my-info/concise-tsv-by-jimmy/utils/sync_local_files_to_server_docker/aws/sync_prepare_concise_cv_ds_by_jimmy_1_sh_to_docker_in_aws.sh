...
#
# This script syncs the prepare_concise_cv_ds_by_jimmy_1.sh file from local machine to AWS server and then to Docker container

# Step 1: Run on local machine to copy the file to AWS server
echo "Creating directory on AWS server and copying prepare_concise_cv_ds_by_jimmy_1.sh..."
...
scp -i /Users/mac/.ssh/aws/aws-icefall.pem /Users/mac/Documents/GitHub/icefall/egs/commonvoice/ASR/pruned_transducer_stateless7_streaming/my-info/concise-tsv-by-jimmy/prepare_concise_cv_ds_by_jimmy_1.sh ubuntu@3.22.99.8:~/icefall/egs/commonvoice/ASR/download/concise-cv-ds-by-jimmy-1/
...
ssh -i /Users/mac/.ssh/aws/aws-icefall.pem ubuntu@3.22.99.8 "docker cp ~/icefall/egs/commonvoice/ASR/download/concise-cv-ds-by-jimmy-1/prepare_concise_cv_ds_by_jimmy_1.sh 432a764e93ea:/root/icefall/egs/commonvoice/ASR/download/concise-cv-ds-by-jimmy-1/"
